package net.bvo.tutorialmod.block;

import net.bvo.tutorialmod.TutorialMod;
import net.bvo.tutorialmod.item.ModItemGroup;
...
public class ModBlocks {
    ...
    public static final Block BVOITE_ORE_BLOCK = registerBlock("bvoite_ore_block",
